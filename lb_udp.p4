...
parser MyParser(packet_in packet,
    ...
    state parse_ipv4 {
        ...
        meta.l4Length = hdr.ipv4.totalLen - 20;
...
control MyIngress(inout headers hdr,
    ...
    action snat_a(bit<32> dstIpAddr, bit<48> dstMacAddr,
                  bit<32> srcIpAddr, bit<48> srcMacAddr,
                  bit<16> srcPort, bit<9> egress_port) {
    ...
    action reverse_snat_a(bit<32> dstIpAddr, bit<16> dstPort, // user ip and port
                          bit<48> dstMacAddr, bit<32> srcIpAddr, 
                          bit<48> srcMacAddr, bit<9> egress_port) {
